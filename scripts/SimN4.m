...
if strcmp(input_mode, 'exp')
    ...
    VPMuncorr.connections(end).parameters={'g_esyn_uncorr',vpmParams(5)*1.5,...
                                    ...
                                    'T',endSim,'jitter_stddev_corr',500,'tau_i_uncorr',25};
    ...
    VPMcorr.connections(end).parameters={'g_esyn_corr',vpmParams(5),...
                                    ...
                                    'T',endSim,'jitter_stddev_corr',500,'tau_i_corr',14};
...
ms_to_s = 1e-3;
disp(['Simulation time: ' num2str(round(length([0:simulation_dt:endSim])*simulation_dt*ms_to_s,3)) 's. (seed ' num2str(seed_num) ')'])

net = dsSimulate(Network,'tspan',tspan,'dt',simulation_dt,'random_seed', seed_num);
end